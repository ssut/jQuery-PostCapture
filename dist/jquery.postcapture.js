...
// Data from mimetype-js (https://github.com/rsdoiel/mimetype-js/blob/master/lib/v0.0.3.js)
var MimeType = function() {
    var mimeDB = {}; // key-value pair

    this.set = function (ext, type) {
        ext = ext.split(',');
        for (var i = 0; i < ext.length; i++) {
            var key = ext[i].substring(1);
            mimeDB[key] = type;
        }
    };
